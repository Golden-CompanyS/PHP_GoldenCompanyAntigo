...
/*Inserção das unidades da federação*/
...
/*Criação da procedure de inserção de funcionário*/
...
/*Criação e execução da view que mostra os funcionários*/
...
select * from seeFuncs where(CPF = '457.168.488-69');

/*Inserções de mensagens dos clientes*/
...
insert into tbclimsg values (default, "Alícia Costa - Dell", "dell.brasil@dell.com", "Prezados, boa noite. Represento a Dell no Brasil, e estamos estonteantemente impressionados com o vosso percurso como start-up. Sua empresa está elegível para se tornar certificada internacionalmente pela Dell.", false);

/*Alterações com erros propositais para a apresentação*/
call insertFunc("111.111.111-11", "Mateus da Silva Taveira", null, "Programador Android", 222, "05133-005", "São Paulo", "SP", "Rua Joaquim Oliveira Freitas","$2y$10$5e7K8zOuFuhz4Cg4Im1IM.2GLE8ohlWL3zcM2CmrTifp9TJ1gqIHC");
update tbfunc set funcNome = "Larisa Miranda Sonoda" where (funcNome = "Larissa Miranda Sonoda");